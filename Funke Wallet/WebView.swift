...
fileprivate let webauthnGetInterface = "__webauthn_get_interface__"
fileprivate let webauthnCreateInterface = "__webauthn_create_interface__"
...
func createWebView(container: UIView, WKSMH: WKScriptMessageHandler, WKND: WKNavigationDelegate, NSO: NSObject, VC: ViewController) -> WKWebView{
    ...
    let getMessageHandler = GetMessageHandler(model: model)
...
extension String {
    static var javascript: String {
        let path = Bundle.main.path(forResource: "Encode", ofType: "js")
